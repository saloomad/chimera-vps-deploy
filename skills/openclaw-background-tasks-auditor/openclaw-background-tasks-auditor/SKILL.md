...
description: Use the OpenClaw background-task layer as a control plane for detached work. Audit it, route it, explain it, and decide when Task Flow should sit above it. Use when working with background tasks, detached work, task ledgers, task audits, or task maintenance.
---
